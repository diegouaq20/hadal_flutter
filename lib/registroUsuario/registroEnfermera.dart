...
class RegistroEnfermera extends StatefulWidget {
  const RegistroEnfermera({super.key});

  @override
  _RegistroEnfermeraState createState() => _RegistroEnfermeraState();
}

class _RegistroEnfermeraState extends State<RegistroEnfermera> {
  ...
  void _register() async {
    ...
    if (permission == LocationPermission.always ||
      ...
      try {
        ...
        await _firestore.collection('usuarioenfermera').doc(uid).set({

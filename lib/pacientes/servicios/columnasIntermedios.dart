...
void main() => runApp(ColumnasIntermedios());

class ColumnasIntermedios extends StatelessWidget {
  @override
          ...
          child: Column(
            ...
            children: [
              ...
              FutureBuilder<QuerySnapshot>(
                future: FirebaseFirestore.instance.collection('serviciosintermedios').get(),
                builder: (context, snapshot) {
                  ...
                  if (snapshot.hasError) {
                    return Text('Error al cargar los servicios Intermedios');
                  }
                  final serviciosIntermediosDocs = snapshot.data!.docs;

                  return Center(
                    child: Wrap(
                      spacing: 20,
                      runSpacing: 20,
                      children: serviciosIntermediosDocs.map((servicioDoc) {

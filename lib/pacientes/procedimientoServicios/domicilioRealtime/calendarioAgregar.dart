...
class CalendarioAgregarRealtime extends StatefulWidget {
  final Servicios servicio;

  CalendarioAgregarRealtime({required this.servicio});

  @override
  _CalendarioAgregarRealtimeState createState() =>
      _CalendarioAgregarRealtimeState();
}

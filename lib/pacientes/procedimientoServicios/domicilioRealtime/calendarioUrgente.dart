...
class CalendarioUrgenteRealtime extends StatefulWidget {
  final Servicios servicio;

  CalendarioUrgenteRealtime({required this.servicio});

  @override
  _CalendarioUrgenteRealtimeState createState() =>
      _CalendarioUrgenteRealtimeState();
}

...
class ListaServiciosBasicos extends StatefulWidget {
  @override
  _ListaServiciosBasicosState createState() => _ListaServiciosBasicosState();
}

class _ListaServiciosBasicosState extends State<ListaServiciosBasicos> {
          ...
          child: Column(
            children: [
              _buildServiciosSection(
                  context, 'serviciosbasicos', 'Elije tu lista'),             
            ],
          ),
        ),
      ),

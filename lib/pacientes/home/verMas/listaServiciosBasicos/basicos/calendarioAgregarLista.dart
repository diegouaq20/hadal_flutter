...
class CalendarioAgregarLista extends StatefulWidget {
  final Servicios servicioLista;

  CalendarioAgregarLista({required this.servicioLista});

  @override
  _CalendarioAgregarListaState createState() => _CalendarioAgregarListaState();
}
            ...
            Container(
              ...
              child: TextButton(
                onPressed: () {
                  ...
                  final serviceName = widget.servicioLista.nombre;
                  final schedule = horarios[_selectedHorarioIndex];
                  final total = widget.servicioLista.total;
                  final icono = widget.servicioLista.icono;
                  final tipoCategoria = widget.servicioLista.tipoCategoria;
                  final ubicacion = widget.servicioLista.ubicacion;
                  Navigator.push(
                    context,
                    MaterialPageRoute(

...
class ListaServiciosAvanzados extends StatefulWidget {
  @override
  _ListaServiciosAvanzadosState createState() => _ListaServiciosAvanzadosState();
}

class _ListaServiciosAvanzadosState extends State<ListaServiciosAvanzados> {
          ...
          child: Column(
            children: [
              _buildServiciosSection(
                  context, 'serviciosavanzados', 'Elije tu lista'),             
            ],
          ),
        ),
      ),

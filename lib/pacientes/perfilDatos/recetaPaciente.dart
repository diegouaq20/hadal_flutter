...
class RecetaPaciente extends StatefulWidget {
  @override
  _RecetaPacienteState createState() => _RecetaPacienteState();
}

class _RecetaPacienteState extends State<RecetaPaciente> {
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        color: Colors.white,
                        child: Text(
                          "Se solicita este documento para conocer más sobre las razones por las que necesita un servicio y mejorar la calidad de la atención.\n\nFormato JPG, PNG o PDF requerido.\n\nFAVOR DE TOMAR UNA FOTO LEGIBLE.",

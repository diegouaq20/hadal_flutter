...
class InePacienteFaltante extends StatefulWidget {
  @override
  _InePacienteFaltanteState createState() => _InePacienteFaltanteState();
}

class _InePacienteFaltanteState extends State<InePacienteFaltante> {

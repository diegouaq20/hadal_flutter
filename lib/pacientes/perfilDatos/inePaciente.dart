...
import 'package:hadal/pacientes/perfilDatos/ine2Paciente.dart';
import 'package:file_picker/file_picker.dart';

class InePaciente extends StatefulWidget {
  @override
  _InePacienteState createState() => _InePacienteState();
}

class _InePacienteState extends State<InePaciente> {
  ...
  void _uploadFile(dynamic file) async {
    try {
      if (file != null) {
        final userId = FirebaseAuth.instance.currentUser!.uid;
        final fileName = "INE"; // Nombre base del archivo
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Ine2Paciente()),
        );
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        color: Colors.white,
                        child: Text(
                          "AQUÍ DEBE SUBIR LA PARTE FRONTAL DE SU INE.\n\nSe solicita este documento de identificación oficial oficial para corroborar su identidad y evitar la creación de perfiles falsos.\n\nFormato JPG, PNG O PDF requerido.\n\nFAVOR DE TOMAR UNA FOTO LEGIBLE.",

...
class ComprobanteDomicilioPaciente extends StatefulWidget {
  @override
  _ComprobanteDomicilioPacienteState createState() =>
      _ComprobanteDomicilioPacienteState();
}

class _ComprobanteDomicilioPacienteState
    extends State<ComprobanteDomicilioPaciente> {
  ...
  void _uploadDocument() async {
    try {
      if ((_isImageSelected && _file != null) ||
        ...
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => RecetaPaciente()));
      }
    } catch (e) {
      print(e.toString());
    }

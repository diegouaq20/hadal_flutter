...
class ComprobanteDomicilioEnfermera extends StatefulWidget {
  @override
  _ComprobanteDomicilioEnfermeraState createState() =>
      _ComprobanteDomicilioEnfermeraState();
}

class _ComprobanteDomicilioEnfermeraState
    extends State<ComprobanteDomicilioEnfermera> {
  ...
  void _uploadDocument() async {
    try {
      if ((_isImageSelected && _file != null) ||
        ...
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => TituloProfecional()));
      }
    } catch (e) {
      print(e.toString());
    }

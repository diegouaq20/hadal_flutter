...
class CedulaProfecionalFaltante extends StatefulWidget {
  @override
  _CedulaProfecionalFaltanteState createState() =>
      _CedulaProfecionalFaltanteState();
}

class _CedulaProfecionalFaltanteState extends State<CedulaProfecionalFaltante> {

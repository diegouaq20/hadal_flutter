...
class PerfilEnfermeraFaltante extends StatefulWidget {
  @override
  _PerfilEnfermeraFaltanteState createState() => _PerfilEnfermeraFaltanteState();
}

class _PerfilEnfermeraFaltanteState extends State<PerfilEnfermeraFaltante> {

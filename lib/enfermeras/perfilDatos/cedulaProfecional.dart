...
import 'package:hadal/enfermeras/perfilDatos/referenciaUno.dart';
import 'package:image_picker/image_picker.dart';
import 'package:flutter_native_image/flutter_native_image.dart';
import 'package:file_picker/file_picker.dart';

class CedulaProfecional extends StatefulWidget {
  @override
  _CedulaProfecionalState createState() => _CedulaProfecionalState();
}

class _CedulaProfecionalState extends State<CedulaProfecional> {
  ...
  void _uploadDocument() async {
    try {
      if ((_isImageSelected && _file != null) ||
        ...
        Navigator.push(
            context, MaterialPageRoute(builder: (context) => ReferenciaUno()));
      }
    } catch (e) {
      print(e.toString());
    }

...
import 'package:hadal/enfermeras/perfilDatos/ine2Enfermera.dart';
import 'package:image_picker/image_picker.dart';
import 'package:flutter_native_image/flutter_native_image.dart';
import 'package:file_picker/file_picker.dart';

class IneEnfermera extends StatefulWidget {
  @override
  _IneEnfermeraState createState() => _IneEnfermeraState();
}

class _IneEnfermeraState extends State<IneEnfermera> {
  ...
  void _uploadFile(dynamic file) async {
    try {
      if (file != null) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Ine2Enfermera()),
        );

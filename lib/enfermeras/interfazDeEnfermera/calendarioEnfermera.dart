...
class CalendarioEnfermera extends StatefulWidget {
  @override
  _CalendarioEnfermeraState createState() => _CalendarioEnfermeraState();
}

class _CalendarioEnfermeraState extends State<CalendarioEnfermera> {

                  ...
                  children: <Widget>[
                      ...
                      child: Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                              labelText: 'Nombre(s)', border: InputBorder.none),
                          onSubmitted: (_) =>
                              FocusScope.of(context).nextFocus(),
                          textCapitalization: TextCapitalization
                              .words, // Capitaliza la primera letra de cada palabra ingresada
                          inputFormatters: [
                            FilteringTextInputFormatter.deny(RegExp('[ ]{2,}'))
                          ], // Rechaza cualquier entrada con más de un espacio
                          onEditingComplete: () {
                            String text = _nameController.text;
                            List<String> words = text.trim().split(
                                ' '); // Elimina los espacios antes de la primera palabra y después de la última palabra
                            String formattedName = '';
                            for (int i = 0; i < words.length; i++) {
                              String word = words[i];
                              if (word.isNotEmpty) {
                                formattedName += word[0].toUpperCase() +
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                              labelText: 'Teléfono', border: InputBorder.none),
                          onSubmitted: (_) {
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: TextField(
                          ...
                          decoration: InputDecoration(
                              labelText: 'Domicilio', border: InputBorder.none),
                          onSubmitted: (_) =>
                              FocusScope.of(context).nextFocus(),
                        ),
                      ),
                    ...
                    Container(
                      decoration: BoxDecoration(
                        borderRadius: BorderRadius.circular(10.0),
                        border: Border.all(
                          color: _passwordConfirmationController.text ==
